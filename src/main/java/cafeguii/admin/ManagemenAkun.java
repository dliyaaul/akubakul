 ...
 * @author Axioo Pongo
 */
public class ManagemenAkun extends javax.swing.JFrame {

    /**
     * Creates new form item_stock
     */
    public ManagemenAkun() {
        initComponents();
        ...
        // Pastikan untuk menambahkan event handler ini di bagian inisialisasi JFrame Anda
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Management Karyawan");
        ...
        table_bahan.setFont(new java.awt.Font("Segoe Print", 0, 12)); // NOI18N
        ...
        txt_hidden.setFont(new java.awt.Font("Yu Gothic UI", 0, 14)); // NOI18N
        ...
        Pangkat.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Pilih", "Pegawai", "Admin"}));
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txt_harga, javax.swing.GroupLayout.PREFERRED_SIZE, 143, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(70, 70, 70)
                                .addComponent(txt_hidden, javax.swing.GroupLayout.PREFERRED_SIZE, 142, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(18, 18, 18)
                        .addComponent(txt_hidden, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Pangkat)
                            .addComponent(txt_harga, javax.swing.GroupLayout.DEFAULT_SIZE, 26, Short.MAX_VALUE)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btn_reset1, javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(31, 31, 31)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btn_produk, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
                    .addComponent(btn_logout, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(btn_bahan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(cb_history1, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(Karyawan, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void loadBahan() {
        if (conn != null) {
            daftarKaryawan = new ArrayList<>();
            String kueri = "SELECT * FROM `karyawan` Order BY Tingkatan ASC";
            try {
                PreparedStatement ps = conn.prepareStatement(kueri);
                ResultSet rs = ps.executeQuery();
                while (rs.next()) {
                    int KodeKaryawan = rs.getInt("KodeKaryawan");
                    String UsernameKasir = rs.getString("UsernameKasir");
                    String Password = rs.getString("Password");
                    String Tingkatan = rs.getString("Tingkatan");
                    Karyawan karya = new Karyawan(KodeKaryawan, UsernameKasir, Password, Tingkatan);
                    daftarKaryawan.add(karya);
                }
                rs.close();
                ps.close();
            } catch (SQLException ex) {
                Logger.getLogger(ManagemenAkun.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void tampilBahan() {
        model.setRowCount(0);
        for (Karyawan b : daftarKaryawan) {
            model.addRow(new Object[]{b.getKodeKaryawan(), b.getUsernameKasir(), b.getPassword(), b.getTingkatan()});
        }
    }
    ...
    private void btn_addActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_addActionPerformed
        ...
        String pangkat = Pangkat.getSelectedItem().toString(); // Ambil teks dari combobox
        // Periksa apakah NamaBahan, hargaText, atau Stok kosong sebelum mencoba melakukan proses tambah data
        if (NamaBahan.isEmpty() || hargaText.isEmpty() || "Pilih".equals(pangkat)) {
            ...
            try (Connection koneksi = DriverManager.getConnection("jdbc:mysql://localhost:3306/akubakulcs", "root", "Opoae_123")) {
                ...
                String kueri = "INSERT INTO karyawan (UsernameKasir, Password, Tingkatan) VALUES (?,?,?)";
                PreparedStatement ps = koneksi.prepareStatement(kueri);
                ps.setString(1, NamaBahan); // Menggunakan nilai unik untuk 'KodeBahan'
                ps.setString(2, hargaText);
                ps.setString(3, pangkat);
    ...
    private int generateUniqueCode() {
        // Anda dapat mengimplementasikan logika Anda untuk menghasilkan nilai unik di sini
        // Misalnya, Anda dapat melakukan query ke database untuk mendapatkan kode terakhir
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        ...
        String pangkat = Pangkat.getSelectedItem().toString(); 
        
        if (NamaBahan.isEmpty() || hargaText.isEmpty() || "Hasil".equals(pangkat)) {
            JOptionPane.showMessageDialog(this, "Isi field yang kosong atau masukkan nilai yang valid.");
            return;
        }
        ...
        try (Connection koneksi = DriverManager.getConnection("jdbc:mysql://localhost:3306/akubakulcs", "root", "Opoae_123")) {
            String kueri = "UPDATE karyawan SET UsernameKasir=?, Password=?, Tingkatan=? WHERE KodeKaryawan=?";
            PreparedStatement ps = koneksi.prepareStatement(kueri);
    ...
    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed
        ...
        int konfirmasi = JOptionPane.showConfirmDialog(this,
                "Anda yakin ingin memecat orang ini? Anaknya 4 loh !!",
        ...
        if (konfirmasi == JOptionPane.YES_OPTION) {
            ...
            try (Connection koneksi = DriverManager.getConnection("jdbc:mysql://localhost:3306/akubakulcs", "root", "Opoae_123")) {
                String kueri = "DELETE FROM karyawan WHERE KodeKaryawan=?";
                PreparedStatement ps = koneksi.prepareStatement(kueri);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManagemenAkun.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManagemenAkun().setVisible(true);
            }
        });
    }
