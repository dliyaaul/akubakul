 ...
 * @author Axioo Pongo
 */
public class Bahan_stock extends javax.swing.JFrame {
    ...
    private void loadBahan() {
        if (conn != null) {
            daftarBahan = new ArrayList<>();
            String kueri = "SELECT * FROM stokbahan";
            try {
    ...
    private void cariBahanbyKeyword(String keyword) {
        if (conn != null) {
            daftarBahan = new ArrayList<>();
    ...
    private void TambahBahanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TambahBahanActionPerformed
        ...
        if (barisTerpilih == -1) {
            JOptionPane.showMessageDialog(this, "Pilih Baris Pada Tabel terlebih dahulu.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        if (input == null || input.trim().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Input tidak boleh kosong. Masukkan angka yang valid.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Bahan_stock.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Bahan_stock().setVisible(true);
            }
        });
    }
